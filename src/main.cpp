...
void enterStage(GameConfig* conf)
{
    ...
    for (t = 0; t < tmax; t++)
    {
                ...
                && ta[t] - fx <= fxmax + 12000 + xx[3])
        {
            ...
            {
                if (ttype[t] < 1000 && ttype[t] != 800
                        && ttype[t] != 140 && ttype[t] != 141)
                {
                    if (!(mztype == 1))
                    {
                        xx[16] = 0;
            ...
            else
            {
                        ...
                        && player->loc.y < xx[9] + sd[t] + xx[0])
                {
                    ...
                    if (stype[t] == 102)
                    {
                        ...
                        {
                            ayobi(conf, sa[t] + 4500, 30000, 0, -1600, 0, 5, 0);
                            ot(oto[10], conf->sound);
                            sxtype[t] = 3;
                            sa[t] -= 12000;
                        }
                        ...
                        {
                            ayobi(conf, sa[t] - 5000 - 3000 * 1, 26000, 0,
                                    -1600, 0, 5, 0);
                            ot(oto[10], conf->sound);
                        }
                        else if (sxtype[t] == 9)
                ...
                if (stype[t] == 180)
                {
                    ...
                    {
                        sr[t] = 0;
                        ayobi(conf, sa[t], 30000, rand(600) - 300,
...
void stagep(GameConfig* conf)
{
    ...
    // 1-2-0(地上)
    else if (conf->stage_info.check(1, 2, 0))
    {
        //マリ　地上　入れ
        chBgm(otom[BGM_FIELD]);
    ...
    // 1-2-1(地下)
    else if (conf->stage_info.check(1, 2, 1))
    {
        //マリ　地下　入れ
    ...
    // 1-2-2 (地上)
    else if (conf->stage_info.check(1, 2, 2))
    {
...
//BGM変更
void chBgm(Mix_Music* music, int volume /* 0~100 */)
{
    Mix_HaltMusic();
